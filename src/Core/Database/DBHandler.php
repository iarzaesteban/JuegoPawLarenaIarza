...
class DBHandler
{
    ...
    public function load($find = null)
    {
        $this->logger->error("DBHandler->load($find) no implementado");
    }
    ...
    public function update($find = null, $updateFields = null)
    {
        $this->logger->error("DBHandler->update($find, $updateFields) no implementado");
    }
