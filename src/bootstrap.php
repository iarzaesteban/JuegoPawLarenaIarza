...
$router->get('/','Menu_principal@index');
$router->get('/crearCuenta','Menu_principal@crearCuenta');
$router->post('/crearCuenta','Menu_principal@crearCuentaAlmacenar');
$router->get('/login','Menu_principal@login');
$router->post('/login','Menu_principal@loginAutenticar');
//$router->get('/loginGoogle','Menu_principal@loginGoogle');
$router->get('/sala','Menu_principal@sala');
$router->get('/crearSala','Menu_principal@crearSala');
$router->post('/salaObtenerListaJugadores','Menu_principal@obtenerListaJugadores');
$router->get('/iniciarJuego','Menu_principal@iniciarJuego');
$router->post('/isJuegoListo','Menu_principal@isJuegoListo');
